...
export const auth = (email,password,isSignUp) => {
    return dispatch => {
       ...
       // let url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAOqDu39bqhp9GbWy3b9xlQ2NedXCPmJXg';
        if(!isSignUp){
         ...
         //   url = 'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAOqDu39bqhp9GbWy3b9xlQ2NedXCPmJXg';
        }
